...
<%--                <li ng-click="timesheetController.menuSelection('employee')" class="active"><a href="#employee">Employee</a></li>--%>
                <li ng-click="timesheetController.menuSelection('employee')" ng-class="{'active' : timesheetController.role == 'employee'}"><a href="#employee">Employee</a></li>
                <li ng-click="timesheetController.menuSelection('internalManager')" ng-class="{'active' : timesheetController.role == 'internalManager'}"><a href="#internalManager">Internal Manager</a></li>
                <li ng-click="timesheetController.menuSelection('externalManager')" ng-class="{'active' : timesheetController.role == 'externalManager'}"><a href="#externalManager">External Manager</a></li>
            </ul><br>
        </div>
