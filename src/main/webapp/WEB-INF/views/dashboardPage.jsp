...
<main ng-cloak >
        ...
        <div class="container-fluid" ng-controller="DashboardController as dashboardController">
            <div class="row content">
                <nav class="col-sm-3 sidenav">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li ng-click="dashboardController.menuSelection('employee') " id="employeeMenuId"
                            ng-class="{ 'active' : dashboardController.role == 'employee' }"/>
                        <a href="#employee">Employee</a>

                        <li ng-click="dashboardController.menuSelection('internalManager') " id="internalManagerId"
                            ng-class="{ 'active' : dashboardController.role == 'internalManager' }"/>
                        ...
                        <li ng-click="dashboardController.menuSelection('externalManager') " id="externalManagerId"
                            ng-class="{ 'active' : dashboardController.role == 'externalManager' }"/>
                ...
                <div class="col-sm-9">
                    <div ng-if="dashboardController.role == 'employee'">
                        <section>
                            <h3><small>Create new timesheet</small></h3>
                            <hr>
                            <form class="form-inline my-2 my-lg-0" ng-submit="dashboardController.submit()" name="createForm">
                                <div class="form-group">
                                    <label class="text" for="startDateTime">From:</label>
                                    <input type="datetime-local" id="startDateTime" name="startDateTime"
                                           ng-model="dashboardController.timesheet.startDateTime"
                                           class="form-control" placeholder="yyyy-MM-dd HH:mm:ss"
                                           min="2001-01-01T00:00:00" required/>
                                </div>

                                <div class="form-group">
                                    <label class="text" for="endDateTime">To:</label>
                                    <input type="datetime-local" id="endDateTime" name="endDateTime"
                                           ng-model="dashboardController.timesheet.endDateTime"
                                           class="form-control" placeholder="yyyy-MM-dd HH:mm:ss"
                                           min="2001-01-01T00:00:00" required/>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr ng-repeat="time in dashboardController.timesheets">
                                        ...
                                        <td class="approveBtn">
                                            <button type="button"
                                                    ng-if="time.approved == false && dashboardController.role == 'internalManager'"
